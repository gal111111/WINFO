...
const simplifiedUi = {
  ...
  consultationText: '在 WhatsApp 说说你的下一步，我们会先回复服务范围、需要准备的资料，以及可行的做法', footerLine: '让每一间来港发展的企业，都能快捷落地、合规经营、稳健成长',
  ...
  bankTitle: '先把业务故事准备好 · 下一步自然清晰',
  bankText: 'WINFO 会按银行的要求，协助你整理资料、协调流程；但我们不代表银行，账户最终能否开立，仍由银行独立审批', budHero: '从市场拓展蓝图 · 到精准落地的 BUD 申请架构',
...
const extendedTraditional = {
  ...
  pages: {
    ...
    contact: {
      label: '聯絡我們', title: '先說說你的情況 · 我們整理最實際的下一步', lead: '可以透過 WhatsApp、電話或電郵找我們。第一次查詢，只需說明你的身份、目前情況、業務性質和希望開始的時間；請勿透過一般表格傳送身份證明或銀行文件', cards: [['WhatsApp', '+852 6651 5286'], ['電郵', 'jeccw@email.com'], ['香港辦公室', '香港九龍觀塘敬業街 61-63 號利維大廈 1 樓 122 室']], note: '一般查詢會先確認服務方向和所需資料；正式文件會在確認安全收集方式後才安排提交'
    },
