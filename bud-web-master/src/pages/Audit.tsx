...
<section id="services" className="py-20 bg-gray-800 text-white">
  <div className="max-w-7xl mx-auto px-5">
    ...
    <h2 className="text-4xl font-semibold text-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">
      {t("new_audit_services_overview_title")}
    </h2>
    
    <p className="text-xl font-normal mb-12 text-center text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">
      {t("audit_details")}
    </p>
  </div>
</section>
...
<section id="annual-audit" className="py-20 bg-gray-900 text-white">
  <div className="max-w-7xl mx-auto px-5">
    <h2 className="text-4xl font-semibold text-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">
      {t("new_audit_annual_audit_title")}
    </h2>
    <ul className="list-disc pl-5 space-y-6 text-lg text-blue-100/90 max-w-4xl mx-auto">
      <li>{t("new_audit_annual_audit_item1")}</li>
      <li>{t("new_audit_annual_audit_item2")}</li>
      <li>{t("new_audit_annual_audit_item3")}</li>
      <li>{t("new_audit_annual_audit_item4")}</li>
      <li>{t("new_audit_annual_audit_item5")}</li>
      <li>{t("new_audit_annual_audit_item6")}</li>
      <li>{t("new_audit_annual_audit_item7")}</li>
    </ul>
  </div>
</section>

{/* Tax Filing Services */}
<section id="tax-filing" className="py-20 bg-gray-800 text-white">
  <div className="max-w-7xl mx-auto px-5">
    <h2 className="text-4xl font-semibold text-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">
      {t("new_audit_tax_filing_title")}
    </h2>
    <ul className="list-disc pl-5 space-y-6 text-lg text-blue-100/90 max-w-4xl mx-auto">
      <li>{t("new_audit_tax_filing_item1")}</li>
      <li>{t("new_audit_tax_filing_item2")}</li>
      <li>{t("new_audit_tax_filing_item3")}</li>
      <li>{t("new_audit_tax_filing_item4")}</li>
      <li>{t("new_audit_tax_filing_item5")}</li>
      <li>{t("new_audit_tax_filing_item6")}</li>
    </ul>
  </div>
</section>

{/* MPF Annual Services */}
<section id="mpf-services" className="py-20 bg-gray-900 text-white">
  <div className="max-w-7xl mx-auto px-5">
    <h2 className="text-4xl font-semibold text-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">
      {t("new_audit_mpf_services_title")}
    </h2>
    <ul className="list-disc pl-5 space-y-6 text-lg text-blue-100/90 max-w-4xl mx-auto">
      <li>{t("new_audit_mpf_services_item1")}</li>
      <li>{t("new_audit_mpf_services_item2")}</li>
      <li>{t("new_audit_mpf_services_item3")}</li>
      <li>{t("new_audit_mpf_services_item4")}</li>
    </ul>
  </div>
</section>

{/* Value-added Services */}
<section id="value-added-services" className="py-20 bg-gray-800 text-white">
  <div className="max-w-7xl mx-auto px-5">
    <h2 className="text-4xl font-semibold text-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">
      {t("new_audit_value_added_title")}
    </h2>
    <ul className="list-disc pl-5 space-y-6 text-lg text-blue-100/90 max-w-4xl mx-auto">
      <li>{t("new_audit_value_added_item1")}</li>
      <li>{t("new_audit_value_added_item2")}</li>
      <li>{t("new_audit_value_added_item3")}</li>
    </ul>
  </div>
</section>
