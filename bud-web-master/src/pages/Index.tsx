      ...
      <div className="min-h-screen bg-gray-900 text-white">
        ...
        <section className="h-[60vh] relative flex flex-col justify-center items-center text-center overflow-hidden">
          <div className="absolute inset-0">
            <div className="absolute inset-0 bg-[url('/images/audit.jpg')] bg-cover bg-center opacity-80"></div>
        ...
        <section id="services" className="py-20 bg-gray-800 text-white">
          <div className="max-w-7xl mx-auto px-5">
            {/* Section Title */}
            <h2 className="text-4xl font-semibold text-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">
              {t("service_overview")}
            </h2>
            
            {/* Service Highlights */}
            <ul className="list-disc pl-5 space-y-6 text-lg text-blue-100/90 max-w-4xl mx-auto">
              <li>{t("service_highlight_1")}</li>
              <li>{t("service_highlight_2")}</li>
              <li>{t("service_highlight_3")}</li>
            </ul>
          </div>
        </section>

{/* Standard Services */}
<section id="standard-services" className="py-20 bg-gray-900 text-white">
  <div className="max-w-7xl mx-auto px-5">
    
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
      {/* Standard Service */}
      <div className="bg-gray-700 rounded-lg p-8 shadow-lg">
        <h3 className="text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">
          {t("standard_services_title")}
        </h3>
        
        <div className="mb-6">
          <p className="text-lg text-blue-100/90 leading-relaxed">{t("standard_item_1")}</p>
        </div>

        <div className="mb-6">
          <ul className="list-disc pl-5 space-y-6 text-lg text-blue-100/90">
            <li>{t("index_subtitle21")}</li>
            <li>{t("index_subtitle22")}</li>
            <li>{t("index_subtitle23")}</li>
            <li>{t("index_subtitle24")}</li>
            <li>{t("index_subtitle25")}</li>
            <li>{t("index_subtitle26")}</li>
            <li>{t("index_subtitle27")}</li>
          </ul>
        </div>

        <p className="text-lg text-blue-100/90 leading-relaxed">{t("standard_bonus")}</p>
      </div>

      {/* Premium Service */}
      <div className="bg-gradient-to-br from-gray-800 via-gray-900 to-black rounded-3xl p-8 shadow-2xl border border-yellow-500/40">
        <h3 className="text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-200">
          {t("premium_services_title")}
        </h3>
        
        <div className="mb-6">
          <p className="text-lg text-yellow-100 leading-relaxed">{t("premium_item_1")}</p>
        </div>

        <div className="mb-6">
          <ul className="list-disc pl-5 space-y-6 text-lg text-yellow-100">
            <li>{t("premium_item_2")}</li>
            <li>{t("premium_item_3")}</li>
          </ul>
        </div>

        <div className="mb-6">
          <p className="text-lg text-yellow-100 leading-relaxed">{t("premium_item_4")}</p>
        </div>
        ...
        <p className="text-lg text-yellow-100 leading-relaxed">{t("standard_bonus")}</p>
      </div>
    </div>
  </div>
</section>
        {/* Value-Added Services */}
        <section id="value-added-services" className="py-20 bg-gray-900 text-white">
          <div className="max-w-7xl mx-auto px-5">
            <h2 className="text-4xl font-semibold text-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">
              {t("premium_item_5")}
            </h2>
            <ul className="list-disc pl-5 space-y-6 text-lg text-blue-100/90 max-w-4xl mx-auto">
              <li>{t("premium_item_6")}</li>
              <li>{t("premium_item_7")}</li>
            </ul>
          </div>
        </section>

        {/* Service Note */}
        <section id="service-note" className="py-20 bg-gray-800 text-white">
          <div className="max-w-7xl mx-auto px-5">
            <p  className="text-xl font-normal text-center text-blue-100/90 max-w-3xl mx-auto">
              {t("service_note")}
            </p>
          </div>
        </section>
        ...
        <section id="contact" className="py-20 bg-gray-900 text-white">
          <div className="max-w-7xl mx-auto px-5 text-center">
            <h2 className="text-4xl font-semibold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">
              {t("contact_title")}
            </h2>
            <GreenButton />
          </div>
