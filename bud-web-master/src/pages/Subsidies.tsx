    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <section className="h-[60vh] relative flex flex-col justify-center items-center text-center overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('/images/innovation.jpg')] bg-cover bg-center opacity-40"></div>
        ...
        <div className="max-w-3xl px-5 z-10">
          <h1 className="leading-snug text-4xl md:text-5xl lg:text-6xl mb-6 font-semibold text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">
            {t("new_innovation_subsidies_title1")}<br/>
            {t("new_innovation_subsidies_title2")}

          </h1>
          <p className="text-lg md:text-xl mb-8 text-blue-100/90 leading-relaxed">
            {t("new_innovation_subsidies_subtitle")}
          </p>
        </div>
      </section>
      ...
      <section className="bg-gray-200 relative text-black">
        ...
        <div className="w-[90%] max-w-7xl mx-auto py-20 relative z-10">
          <h2 className="text-3xl font-semibold mb-12 text-center">
            {t("new_innovation_support_details_title")}
          </h2>
          <div className="space-y-12">
            {/* 學歷分級補貼 */}
            <div>
              <h3 className="text-xl font-semibold mb-4">
                {t("new_innovation_education_subsidy_title")}
              </h3>
              <p className="mb-4">{t("new_innovation_education_subsidy_objective")}</p>
              <ul className="list-disc pl-5 space-y-2">
                <li>{t("new_innovation_education_subsidy_eligibility")}</li>
                <li>{t("new_innovation_education_subsidy_features")}</li>
              </ul>
              <p className="mt-4">{t("new_innovation_education_subsidy_application")}</p>
            </div>

            {/* 港澳青年創業支持 */}
            <div>
              <h3 className="text-xl font-semibold mb-4">
                {t("new_innovation_youth_support_title")}
              </h3>
              <p className="mb-4">{t("new_innovation_youth_support_description")}</p>
              <ul className="list-disc pl-5 space-y-2">
                <li>{t("new_innovation_youth_support_funding")}</li>
                <li>{t("new_innovation_youth_support_mentorship")}</li>
                <li>{t("new_innovation_youth_support_visits")}</li>
              </ul>
              <p className="mt-4">{t("new_innovation_youth_support_note")}</p>
            </div>

            {/* 夢工場辦公室/住房「一元租」優惠 */}
            <div>
              <h3 className="text-xl font-semibold mb-4">
                {t("new_innovation_dream_factory_title")}
              </h3>
              <ul className="list-disc pl-5 space-y-2">
                <li>{t("new_innovation_dream_factory_office")}</li>
                <li>{t("new_innovation_dream_factory_housing")}</li>
                <li>{t("new_innovation_dream_factory_facilities")}</li>
                <li>{t("sub_1")}</li>
                <ul className="list-disc pl-5 space-y-2">
                    <li>{t("new_innovation_dream_factory_subsidies")}</li>
                    <li>{t("new_innovation_dream_factory_housing_subsidies")}</li>
                    <li>{t("new_innovation_dream_factory_living_subsidies")}</li>
                </ul>
              </ul>
            </div>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4">
                {t("new_innovation_policy_support_title")}
              </h3>
              <p className="mb-4">{t("new_innovation_policy_support_description")}</p>
              <ul className="list-disc pl-5 space-y-2">
                <li>{t("new_innovation_policy_support_scope")}</li>
                <li>{t("new_innovation_policy_support_application")}</li>
              </ul>
            </div>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4">
                {t("new_innovation_tax_incentives_title")}
              </h3>
              <ul className="list-disc pl-5 space-y-2">
                <li>{t("new_innovation_tax_incentives_personal")}</li>
                <li>{t("new_innovation_tax_incentives_data")}</li>
              </ul>
            </div>
          </div>
        </div>
